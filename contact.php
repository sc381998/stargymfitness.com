...
$recipient = 'skygymfitness@gmail.com';

$referers = array('skygymfitness.com', 'www.skygymfitness.com');

$success_url = 'http://skygymfitness.com/thanks.php';

$siteurl = 'http://www.skygymfitness.com';

# SMTP MAIL Config
$SMTPhost = 'skygymfitness.com'; // Mail Server Address or IP
$SMTPusername = 'noreply@skygymfitness.com'; // Email Username
$SMTPpassword = 'jTSj=0IlmMyv'; // Password
...
if ($_POST) {
    ...
    $body .= "--------------------------------------------------<br>";
    $body .= "Feedback Powered by apexinvention.com. Visit us @ http://www.apexinvention.com";
    ...
    $header .= "From: Teaplus Connection<$username>";
